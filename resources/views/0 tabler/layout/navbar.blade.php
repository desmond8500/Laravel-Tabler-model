    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('tabler.index') }}" >
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('tabler.erp.contacts') }}" >
                        Contacts
                    </a>
                ...
                <form action="." method="get">
                    ...
                    {{-- <input type="text" class="form-control" wire:model="search" placeholder="Chercher" aria-label="Search in website"> --}}
                    </div>
                </form>
                </div>
            </div>
